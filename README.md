...
restaurant-franchise theme, names, interface, and placeholder artwork.
...
- A native SwiftUI presentation following the Modern Franchise Atlas direction

Drive-Thru Order and Secret Recipe spaces currently have no card effects.
Restaurant upgrades, trading, and final artwork are also intentionally deferred.
...
scheme on an iPhone simulator. The current UI has been verified on iPhone 13.
...
5. **Accessibility and final-art pass**
   ...
   replacing native placeholder graphics with original production assets.
